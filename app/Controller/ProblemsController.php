 ...
 */
	public function add() {
		...
		$creators = $this->Problem->Creator->find('list');
		$beneficiaries = $this->Problem->Beneficiary->find('list');
		$needs = $this->Problem->Need->find('list');
		$this->set(compact('creators', 'beneficiaries', 'needs'));
	}
