 ...
 */
	public function add() {
		...
		$parishes = $this->University->Parish->find('list');
		$universities = $this->University->University->find('list');
		$administrators = $this->University->Administrator->find('list');
		$careers = $this->University->Career->find('list');
		$users = $this->University->User->find('list');
		$this->set(compact('parishes', 'universities', 'administrators', 'careers', 'users'));
	}
