...
<?php echo $this->Form->create('Parish'); ?>
	<fieldset>
		<legend><?php echo __('Edit Parish'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Parish.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Parish.id'))); ?></li>
